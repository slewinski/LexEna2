...
namespace LexEnaTrs.Web
{
    ...
    public partial class DokOdebr
    {
        ...
        internal sealed class DokOdebrMetadata
        {
            ...
            [Include]
            public EntityCollection<PdfStore> PdfStore { get; set; }
    ...
    public partial class JednostkaOrg
    {
        ...
        internal sealed class JednostkaOrgMetadata
        {
            ...
            public string kontoZwrotOplaty { get; set; }
        ...
        public partial class JednostkaWindykacji
        {
            ...
            internal sealed class JednostkaWindykacjiMetadata
            {
                ...
                public Nullable<int> KorespKomo { get; set; }

                public Nullable<int> KorespKomobuf { get; set; }

                public Nullable<int> Nakaz { get; set; }

                public Nullable<int> Nakazbuf { get; set; }

                public Nullable<int> NakazEPU { get; set; }

                public Nullable<int> NakazEPUbuf { get; set; }

                public string Nazwa { get; set; }

                public int PartitionKey { get; set; }

                public Nullable<int> Pozew { get; set; }

                public Nullable<int> PozewBig { get; set; }

                public Nullable<int> Pozewbuf { get; set; }

                public Nullable<int> PozewEPU { get; set; }

                public Nullable<int> PozewEPUBig { get; set; }

                public Nullable<int> PozewEPUbuf { get; set; }

                public Nullable<int> Sprzeciw { get; set; }

                public Nullable<int> Sprzeciwbuf { get; set; }

                public int TypJednostki { get; set; }

                public Nullable<int> Tytul { get; set; }

                public Nullable<int> Tytulbuf { get; set; }

                public Nullable<int> TytulEPU { get; set; }

                public Nullable<int> TytulEPUbuf { get; set; }

                public Nullable<int> Wnioski { get; set; }

                public Nullable<int> Wnioskibuf { get; set; }

                public Nullable<int> WnioskiEgzBig { get; set; }

                public Nullable<int> WnioskiEgzBuf { get; set; }

                public Nullable<int> WnioskiEgzEPU { get; set; }

                public Nullable<int> WnioskiEgzEPUBig { get; set; }
            }
        }
    ...
    public partial class Naleznosc
    {
        ...
        internal sealed class NaleznoscMetadata
        {
            ...
            public Nullable<DateTime> Data_prz_KSEF { get; set; }
...
// The MetadataTypeAttribute identifies vw_ListaDoOdebrMetadata as the class
    ...
    public partial class vw_ListaSpraw
    {
	    ...
	    public int ExtraStatus { get; set; }
            ...
            public string PrzyczynaZwrot { get; set; }
        }
    }
...
// The MetadataTypeAttribute identifies vw_tmpZmianaAdresuPelnMetadata as the class
    ...
    // The MetadataTypeAttribute identifies ImportMetadata as the class
    // that carries additional metadata for the Import class.
    [MetadataTypeAttribute(typeof(Import.ImportMetadata))]
    public partial class Import
    {
        ...
        internal sealed class ImportMetadata
        {
            ...
            public EntityCollection<ImportDetail> ImportDetail { get; set; }

            public int JednostkaWindykacji_Id { get; set; }

            public string md5 { get; set; }

            public string NazwaZbioru { get; set; }
    ...
    // The MetadataTypeAttribute identifies ZgonyDetailsMetadata as the class
    // that carries additional metadata for the ZgonyDetails class.
    [MetadataTypeAttribute(typeof(ZgonyDetails.ZgonyDetailsMetadata))]
    public partial class ZgonyDetails
    {

        // This class allows you to attach custom attributes to properties
        // of the ZgonyDetails class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class ZgonyDetailsMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private ZgonyDetailsMetadata()
            {
            }

            public Nullable<DateTime> DataPlatnosciKosztow { get; set; }

            public Nullable<DateTime> DataPlatnosciNalGl { get; set; }

            public Nullable<DateTime> DataPlatnosciOdsetek { get; set; }

            public Nullable<DateTime> DataPrzedawnieniaKosztow { get; set; }

            public Nullable<DateTime> DataPrzedawnieniaNalGl { get; set; }

            public Nullable<DateTime> DataPrzedawnieniaOdsetek { get; set; }

            public string KontoKsiegowe { get; set; }

            public Nullable<decimal> KosztyKsiegowaNiePrzedaw { get; set; }

            public Nullable<decimal> KosztyKsiegowaPrzedaw { get; set; }

            public Nullable<int> IdSprWiena { get; set; }

            public Nullable<decimal> NalGlownaKsiegowa { get; set; }

            public Nullable<decimal> NalGlownaKsiegowaNiePrzedaw { get; set; }

            public Nullable<decimal> NalGlownaKsiegowaPrzedaw { get; set; }

            public Nullable<decimal> OdsetkiKapitalKsiegowaNiePrzedaw { get; set; }

            public Nullable<decimal> OdsetkiKapitalKsiegowaPrzedaw { get; set; }

            public Nullable<decimal> OdsetkiNaliczoneKsiegowaNiePrzedaw { get; set; }

            public Nullable<decimal> OdsetkiNaliczoneKsiegowaPrzedaw { get; set; }

            public Nullable<decimal> OdsetkiZaksKsiegowaNiePrzedaw { get; set; }

            public Nullable<decimal> OdsetkiZaksKsiegowaPrzedaw { get; set; }

            public Nullable<decimal> SaldoKSiegowe { get; set; }
            ...
            public Nullable<decimal> WDZKsiegowaNiePrzedaw { get; set; }

            public Nullable<decimal> WDZKsiegowaPrzedaw { get; set; }

            public Nullable<decimal> WindykKosztyEgz { get; set; }

            public Nullable<decimal> WindykOdsetki { get; set; }

            public int ZgonyDetails_Id { get; set; }

            public Nullable<int> ZgonyHeader_ID { get; set; }
        }
    }

    // The MetadataTypeAttribute identifies ZgonyHeaderMetadata as the class
    // that carries additional metadata for the ZgonyHeader class.
    [MetadataTypeAttribute(typeof(ZgonyHeader.ZgonyHeaderMetadata))]
    public partial class ZgonyHeader
    {

        // This class allows you to attach custom attributes to properties
        // of the ZgonyHeader class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class ZgonyHeaderMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private ZgonyHeaderMetadata()
            {
            }

            public Nullable<DateTime> DataImportu { get; set; }

            public Nullable<DateTime> DataZestawienia { get; set; }

            public Nullable<Guid> GuidZestawienia { get; set; }

            public string StatusText { get; set; }

            public Nullable<int> StatusZestawienia { get; set; }

            public string UserName { get; set; }

            public int ZgonyHeader_Id { get; set; }
        }
    }
    // The MetadataTypeAttribute identifies ImportDetailMetadata as the class
    // that carries additional metadata for the ImportDetail class.
    [MetadataTypeAttribute(typeof(ImportDetail.ImportDetailMetadata))]
    public partial class ImportDetail
    {

        // This class allows you to attach custom attributes to properties
        // of the ImportDetail class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class ImportDetailMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private ImportDetailMetadata()
            {
            }
            ...
            public Nullable<int> ErrLevel { get; set; }
    ...
    // The MetadataTypeAttribute identifies vw_ImportyMetadata as the class
    // that carries additional metadata for the vw_Importy class.
    [MetadataTypeAttribute(typeof(vw_Importy.vw_ImportyMetadata))]
    public partial class vw_Importy
    {

        // This class allows you to attach custom attributes to properties
        // of the vw_Importy class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class vw_ImportyMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private vw_ImportyMetadata()
            {
            }
            ...
            public string ImExpDescr { get; set; }
    ...
    // The MetadataTypeAttribute identifies vw_ImportDetailsMetadata as the class
    // that carries additional metadata for the vw_ImportDetails class.
    [MetadataTypeAttribute(typeof(vw_ImportDetails.vw_ImportDetailsMetadata))]
    public partial class vw_ImportDetails
    {

        // This class allows you to attach custom attributes to properties
        // of the vw_ImportDetails class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class vw_ImportDetailsMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private vw_ImportDetailsMetadata()
            {
            }
    ...
    // The MetadataTypeAttribute identifies MapDokKomMetadata as the class
    // that carries additional metadata for the MapDokKom class.
    [MetadataTypeAttribute(typeof(MapDokKom.MapDokKomMetadata))]
    public partial class MapDokKom
    {

        // This class allows you to attach custom attributes to properties
        // of the MapDokKom class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class MapDokKomMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private MapDokKomMetadata()
            {
            }

            public int czyPrzenosic { get; set; }

            public int Id { get; set; }

            public Nullable<int> idWienaNazwa { get; set; }
            ...
            public string przycz_bezskut { get; set; }

            public string przycz_zawiesz { get; set; }
        }
    }

    // The MetadataTypeAttribute identifies SadSlownikMetadata as the class
    // that carries additional metadata for the SadSlownik class.
    [MetadataTypeAttribute(typeof(SadSlownik.SadSlownikMetadata))]
    public partial class SadSlownik
    {

        // This class allows you to attach custom attributes to properties
        // of the SadSlownik class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class SadSlownikMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private SadSlownikMetadata()
            {
            }
            ...
            public Nullable<int> id_wiena { get; set; }
            ...
            public EntityCollection<SadSprawa> SadSprawa { get; set; }
    ...
    // The MetadataTypeAttribute identifies SadSprawaMetadata as the class
    // that carries additional metadata for the SadSprawa class.
    [MetadataTypeAttribute(typeof(SadSprawa.SadSprawaMetadata))]
    public partial class SadSprawa
    {

        // This class allows you to attach custom attributes to properties
        // of the SadSprawa class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class SadSprawaMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private SadSprawaMetadata()
            {
            }
            ...
            public Nullable<DateTime> d_skierowania { get; set; }
            ...
            public Nullable<int> sad_id { get; set; }

            public SadSlownik SadSlownik { get; set; }
    ...
    #region BIG
    // The MetadataTypeAttribute identifies BIG_CaseMetadata as the class
    // that carries additional metadata for the BIG_Case class.
    [MetadataTypeAttribute(typeof(BIG_Case.BIG_CaseMetadata))]
    public partial class BIG_Case
    {

        // This class allows you to attach custom attributes to properties
        // of the BIG_Case class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class BIG_CaseMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private BIG_CaseMetadata()
            {
            }

            public int BIG_CaseId { get; set; }

            public EntityCollection<BIG_Debtor> BIG_Debtor { get; set; }

            public BIG_Import BIG_Import { get; set; }

            public Nullable<int> BIG_ImportId { get; set; }

            public EntityCollection<BIG_Obligation> BIG_Obligation { get; set; }

            public EntityCollection<BIG_Operacja> BIG_Operacja { get; set; }
            ...
            public Nullable<DateTime> SuspendDate { get; set; }
        }
    }

    // The MetadataTypeAttribute identifies BIG_DebtorMetadata as the class
    // that carries additional metadata for the BIG_Debtor class.
    [MetadataTypeAttribute(typeof(BIG_Debtor.BIG_DebtorMetadata))]
    public partial class BIG_Debtor
    {

        // This class allows you to attach custom attributes to properties
        // of the BIG_Debtor class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class BIG_DebtorMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private BIG_DebtorMetadata()
            {
            }
            ...
            public BIG_Case BIG_Case { get; set; }
    ...
    // The MetadataTypeAttribute identifies BIG_ImportMetadata as the class
    // that carries additional metadata for the BIG_Import class.
    [MetadataTypeAttribute(typeof(BIG_Import.BIG_ImportMetadata))]
    public partial class BIG_Import
    {

        // This class allows you to attach custom attributes to properties
        // of the BIG_Import class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class BIG_ImportMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private BIG_ImportMetadata()
            {
            }

            public EntityCollection<BIG_Case> BIG_Case { get; set; }

            public int BIG_ImportId { get; set; }

            public EntityCollection<BIG_Operacja> BIG_Operacja { get; set; }

            public Nullable<Guid> ChunkId { get; set; }

            public Nullable<DateTime> DataImportu { get; set; }

            public Nullable<DateTime> DataStatusu { get; set; }

            public Nullable<DateTime> DataWysylki { get; set; }
    ...
    // The MetadataTypeAttribute identifies BIG_KonfigMetadata as the class
    // that carries additional metadata for the BIG_Konfig class.
    [MetadataTypeAttribute(typeof(BIG_Konfig.BIG_KonfigMetadata))]
    public partial class BIG_Konfig
    {

        // This class allows you to attach custom attributes to properties
        // of the BIG_Konfig class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class BIG_KonfigMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private BIG_KonfigMetadata()
            {
            }

            public int BIG_KonfigId { get; set; }
    ...
    // The MetadataTypeAttribute identifies BIG_ObligationMetadata as the class
    // that carries additional metadata for the BIG_Obligation class.
    [MetadataTypeAttribute(typeof(BIG_Obligation.BIG_ObligationMetadata))]
    public partial class BIG_Obligation
    {

        // This class allows you to attach custom attributes to properties
        // of the BIG_Obligation class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class BIG_ObligationMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private BIG_ObligationMetadata()
            {
            }
            ...
            public Nullable<DateTime> DataFaktury { get; set; }

            public Nullable<DateTime> DataTytWyk { get; set; }

            public Nullable<DateTime> DataWymag { get; set; }

            public Nullable<DateTime> DataWysWezw { get; set; }
    ...
    // The MetadataTypeAttribute identifies BIG_OperacjaMetadata as the class
    // that carries additional metadata for the BIG_Operacja class.
    [MetadataTypeAttribute(typeof(BIG_Operacja.BIG_OperacjaMetadata))]
    public partial class BIG_Operacja
    {

        // This class allows you to attach custom attributes to properties
        // of the BIG_Operacja class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class BIG_OperacjaMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private BIG_OperacjaMetadata()
            {
            }
            ...
            public BIG_Debtor BIG_Debtor { get; set; }
            ...
            public BIG_Obligation BIG_Obligation { get; set; }

            public Nullable<int> BIG_ObligationId { get; set; }

            public int BIG_OperacjaId { get; set; }

            public Nullable<DateTime> DataOperacji { get; set; }

            public Nullable<DateTime> DataProcedowaniaKrd { get; set; }
    ...
    // The MetadataTypeAttribute identifies BIGvw_DluznicyMetadata as the class
    // that carries additional metadata for the BIGvw_Dluznicy class.
    [MetadataTypeAttribute(typeof(BIGvw_Dluznicy.BIGvw_DluznicyMetadata))]
    public partial class BIGvw_Dluznicy
    {

        // This class allows you to attach custom attributes to properties
        // of the BIGvw_Dluznicy class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class BIGvw_DluznicyMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private BIGvw_DluznicyMetadata()
            {
            }
    ...
    // The MetadataTypeAttribute identifies BIGvw_DluznicyAktualMetadata as the class
    // that carries additional metadata for the BIGvw_DluznicyAktual class.
    [MetadataTypeAttribute(typeof(BIGvw_DluznicyAktual.BIGvw_DluznicyAktualMetadata))]
    public partial class BIGvw_DluznicyAktual
    {

        // This class allows you to attach custom attributes to properties
        // of the BIGvw_DluznicyAktual class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class BIGvw_DluznicyAktualMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private BIGvw_DluznicyAktualMetadata()
            {
            }
    ...
    // The MetadataTypeAttribute identifies BIGvw_ImportWiena2BIGMetadata as the class
    // that carries additional metadata for the BIGvw_ImportWiena2BIG class.
    [MetadataTypeAttribute(typeof(BIGvw_ImportWiena2BIG.BIGvw_ImportWiena2BIGMetadata))]
    public partial class BIGvw_ImportWiena2BIG
    {

        // This class allows you to attach custom attributes to properties
        // of the BIGvw_ImportWiena2BIG class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class BIGvw_ImportWiena2BIGMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private BIGvw_ImportWiena2BIGMetadata()
            {
            }
            ...
            public Nullable<DateTime> data_r { get; set; }

            public Nullable<DateTime> dataklauzuli { get; set; }

            public Nullable<DateTime> dataorzecz { get; set; }
            ...
            public decimal splata { get; set; }

            public string sygnatura { get; set; }

            public string sygnaturasad { get; set; }

            public short typ_nal { get; set; }
    ...
    // The MetadataTypeAttribute identifies BIGvw_ImportyDetailMetadata as the class
    // that carries additional metadata for the BIGvw_ImportyDetail class.
    [MetadataTypeAttribute(typeof(BIGvw_ImportyDetail.BIGvw_ImportyDetailMetadata))]
    public partial class BIGvw_ImportyDetail
    {

        // This class allows you to attach custom attributes to properties
        // of the BIGvw_ImportyDetail class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class BIGvw_ImportyDetailMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private BIGvw_ImportyDetailMetadata()
            {
            }
    ...
    // The MetadataTypeAttribute identifies BIGvw_ObligationLastStatusMetadata as the class
    // that carries additional metadata for the BIGvw_ObligationLastStatus class.
    [MetadataTypeAttribute(typeof(BIGvw_ObligationLastStatus.BIGvw_ObligationLastStatusMetadata))]
    public partial class BIGvw_ObligationLastStatus
    {

        // This class allows you to attach custom attributes to properties
        // of the BIGvw_ObligationLastStatus class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class BIGvw_ObligationLastStatusMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private BIGvw_ObligationLastStatusMetadata()
            {
            }
    ...
    #endregion BIG
    #region UZD
    // The MetadataTypeAttribute identifies UZD_PakietWplatMetadata as the class
    // that carries additional metadata for the UZD_PakietWplat class.
    [MetadataTypeAttribute(typeof(UZD_PakietWplat.UZD_PakietWplatMetadata))]
    public partial class UZD_PakietWplat
    {

        // This class allows you to attach custom attributes to properties
        // of the UZD_PakietWplat class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class UZD_PakietWplatMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private UZD_PakietWplatMetadata()
            {
            }

            public Nullable<DateTime> DataImportu { get; set; }

            public DateTime DataTypowania { get; set; }

            public string importer { get; set; }

            public Nullable<int> LWplat { get; set; }

            public string Opis { get; set; }

            public Nullable<int> Status { get; set; }

            public int UZD_PakietWplatId { get; set; }

            public EntityCollection<UZD_Wplata> UZD_Wplata { get; set; }
        }
    }

    // The MetadataTypeAttribute identifies UZD_WplataMetadata as the class
    // that carries additional metadata for the UZD_Wplata class.
    [MetadataTypeAttribute(typeof(UZD_Wplata.UZD_WplataMetadata))]
    public partial class UZD_Wplata
    {

        // This class allows you to attach custom attributes to properties
        // of the UZD_Wplata class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class UZD_WplataMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private UZD_WplataMetadata()
            {
            }
            ...
            public Nullable<int> IdWplWiena { get; set; }

            public Nullable<int> Kto { get; set; }

            public decimal Kwota { get; set; }

            public decimal KwotaVAT { get; set; }

            public decimal KwotaW { get; set; }
            ...
            public UZD_Faktura UZD_Faktura { get; set; }

            public Nullable<int> UZD_FakturaId { get; set; }

            public UZD_PakietWplat UZD_PakietWplat { get; set; }

            public Nullable<int> UZD_PakietWplatId { get; set; }

            public UZD_Wplata UZD_Wplata1 { get; set; }

            public UZD_Wplata UZD_Wplata2 { get; set; }

            public int UZD_WplataId { get; set; }
        }
    }

    // The MetadataTypeAttribute identifies UZDvw_WplatyMetadata as the class
    // that carries additional metadata for the UZDvw_Wplaty class.
    [MetadataTypeAttribute(typeof(UZDvw_Wplaty.UZDvw_WplatyMetadata))]
    public partial class UZDvw_Wplaty
    {

        // This class allows you to attach custom attributes to properties
        // of the UZDvw_Wplaty class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class UZDvw_WplatyMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private UZDvw_WplatyMetadata()
            {
            }

            public DateTime DataWpl { get; set; }

            public Nullable<DateTime> DataWymagalnosci { get; set; }
            ...
            public Nullable<decimal> KwotaFaktury { get; set; }
    ...
    [MetadataTypeAttribute(typeof(UZD_Konfig.UZD_KonfigMetadata))]
    public partial class UZD_Konfig
    {

        // This class allows you to attach custom attributes to properties
        // of the UZD_Konfig class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class UZD_KonfigMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private UZD_KonfigMetadata()
            {
            }

            public decimal ProgFaktura { get; set; }

            public int UZD_KonfigId { get; set; }
        }
    }

    // The MetadataTypeAttribute identifies UZD_PakietMetadata as the class
    // that carries additional metadata for the UZD_Pakiet class.
    [MetadataTypeAttribute(typeof(UZD_Pakiet.UZD_PakietMetadata))]
    public partial class UZD_Pakiet
    {

        // This class allows you to attach custom attributes to properties
        // of the UZD_Pakiet class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class UZD_PakietMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private UZD_PakietMetadata()
            {
            }

            public Nullable<DateTime> DataPotwierdzenia { get; set; }

            public Nullable<DateTime> DataTypowania { get; set; }
    ...
    // The MetadataTypeAttribute identifies UZDvw_PakietMetadata as the class
    // that carries additional metadata for the UZDvw_Pakiet class.
    [MetadataTypeAttribute(typeof(UZDvw_Pakiet.UZDvw_PakietMetadata))]
    public partial class UZDvw_Pakiet
    {

        // This class allows you to attach custom attributes to properties
        // of the UZDvw_Pakiet class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class UZDvw_PakietMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private UZDvw_PakietMetadata()
            {
            }
    ...
    // The MetadataTypeAttribute identifies UZD_FakturaMetadata as the class
    // that carries additional metadata for the UZD_Faktura class.
    [MetadataTypeAttribute(typeof(UZD_Faktura.UZD_FakturaMetadata))]
    public partial class UZD_Faktura
    {

        // This class allows you to attach custom attributes to properties
        // of the UZD_Faktura class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class UZD_FakturaMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private UZD_FakturaMetadata()
            {
            }
            ...
            public Nullable<DateTime> DataSprzedazy { get; set; }

            public Nullable<DateTime> DataUlgi { get; set; }

            public Nullable<DateTime> DataWeryfNIP { get; set; }

            public Nullable<DateTime> DataWymagalnosci { get; set; }

            public Nullable<DateTime> DataZaleglosci { get; set; }
            ...
            public Nullable<int> IdZestawGl { get; set; }
            ...
            public string NrZestawu { get; set; }
            ...
            public UZD_Pakiet UZD_Pakiet { get; set; }
    ...
    [MetadataTypeAttribute(typeof(DataBuffer.DataBufferMetadata))]
    public partial class DataBuffer
    {

        // This class allows you to attach custom attributes to properties
        // of the DataBuffer class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class DataBufferMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private DataBufferMetadata()
            {
            }
            ...
            public Nullable<Guid> ident { get; set; }
    ...
    [MetadataTypeAttribute(typeof(DOKEKSTR_SygnLst.DOKEKSTR_SygnLstMetadata))]
    public partial class DOKEKSTR_SygnLst
    {

        // This class allows you to attach custom attributes to properties
        // of the DOKEKSTR_SygnLst class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class DOKEKSTR_SygnLstMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private DOKEKSTR_SygnLstMetadata()
            {
            }
    ...
    // The MetadataTypeAttribute identifies DOKEKSTRvw_ekstrakcjaMetadata as the class
    // that carries additional metadata for the DOKEKSTRvw_ekstrakcja class.
    [MetadataTypeAttribute(typeof(DOKEKSTRvw_ekstrakcja.DOKEKSTRvw_ekstrakcjaMetadata))]
    public partial class DOKEKSTRvw_ekstrakcja
    {

        // This class allows you to attach custom attributes to properties
        // of the DOKEKSTRvw_ekstrakcja class.
        //
        // For example, the following marks the Xyz property as a
        // required property and specifies the format for valid values:
        //    [Required]
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class DOKEKSTRvw_ekstrakcjaMetadata
        {

            // Metadata classes are not meant to be instantiated.
            private DOKEKSTRvw_ekstrakcjaMetadata()
            {
            }

            public Nullable<DateTime> d_dok { get; set; }

            public int id { get; set; }

            public Nullable<int> iddok { get; set; }

            public Nullable<int> idnazwy { get; set; }

            public Guid idpack { get; set; }

            public Nullable<int> idskan { get; set; }

            public Nullable<int> idsprawy { get; set; }

            public string kancelaria { get; set; }
