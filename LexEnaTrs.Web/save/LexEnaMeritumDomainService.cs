...
namespace LexEnaTrs.Web
{
    ...
    public class LexEnaMeritumDomainService : LinqToEntitiesDomainService<LexEnaMeritumEntities>
    {
        ...
        {
            return this.ObjectContext.NazwyOdsetek;
        }
 ...
 // TODO:
 	...
 	// TODO:
        ...
        {
            return this.ObjectContext.Naleznosc.Where(a => a.Sprawa_id == IdSprawy);
        }
        ...
        {
            return this.ObjectContext.Sprawa.Include("DaneDluznika").Include("Naleznosc").Include("Wplata").Include("JednostkaOrg").Where(a => a.id == IdSprawy).FirstOrDefault();
        ...
        {
            return this.ObjectContext.Uzytkownik.Include("KontoEPU").Where(a => a.UserName == UserName).FirstOrDefault();
        }
        ...
        {
            return this.ObjectContext.DokOdebr.Where(a => a.Sprawa_id == IdSprawy).OrderBy(a => a.Id);
        }
