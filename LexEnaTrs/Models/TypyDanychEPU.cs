...
namespace LexEnaTrs
{
    public static class Constants
    {
        ...
        public const string oldnamespace = "http://www.currenda.pl/epu";
        public const string currnamespace = "http://www.currenda.pl/epu"; //"http://www.e-sad.gov.pl/epu";"http://www.currenda.pl/epu";
    }
...
[System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    ...
    [System.Xml.Serialization.XmlElement("Opis")]
    public string Opis
    {
        get
        {
    ...
    [System.Xml.Serialization.XmlAttributeAttribute("doZaplaty")]
        ...
        public string XmlDateTimedataod
        {
            ...
            get {
            if (this.dataOdField > new DateTime(2000, 1, 1))
                 return this.dataOdField.ToString("yyyy-MM-dd");
            else
                return null;    
            }       
    ...
    public partial class typRoszczenie:INotifyPropertyChanged
    {
        ...
        public int Solidarnie
        {
            ...
            set
            {
                ...
                if (value != this.solidarnieField && value >=0)
                {
        ...
        public int Typ 
        {
            ...
            set
            {
                if (value != this.typField && value>=0)
                {
                    this.typField = value;
        ...
        [System.Xml.Serialization.XmlAttributeAttribute("dataWymagalnosci")]
        public string dataWymagalnosci
        {
            ...
            set
            {
                if (value != this.dataWymagalnosciField)
                {
                    this.dataWymagalnosciField = value;
                    this.OnPropertyChanged("dataWymagalnosci");
                }
            }
        }
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace = Constants.currnamespace)]
    public partial class typRachunekDoZwrotuOplat:INotifyPropertyChanged
    {
        ...
        public string NumerRachunkuDoZwrotuOplat
        {
            ...
            set
            {
                ...
                OnPropertyChanged("NumerRachunkuDoZwrotuOplat");
            }
        }
        ...
        public string WlascicielRachunku
        {
            ...
            set
            {
                ...
                OnPropertyChanged("WlascicielRachunku");
            }
        }
    }
    ...
    public partial class typOsoba:INotifyPropertyChanged
    {
        ...
        public string PESEL
        {
            get
            {
                if (this.pESELField.Trim().Length == 0)
                    this.pESELField = null;
    ...
    public partial class typStrona:INotifyPropertyChanged
    {
        ...
        public typStrona()
        {
            ...
            RodzajStrony = 0;
            ObcokrajowiecString = String.Empty;
            Obcokrajowiec = false;
            BrakNumerowIdentyfikacyjnych = false;
        ...
        [XmlElement(ElementName = "ObcokrajowiecString", IsNullable = true)]
        public string ObcokrajowiecString
        {
            ...
            set
            {
                ...
                this.OnPropertyChanged("ObcokrajowiecString");
        ...
        public bool Obcokrajowiec
        {
            ...
            set
            {
                if (this.obcokrajowiecField != value)
                {
                    this.obcokrajowiecField = value;
                    this.OnPropertyChanged("Obcokrajowiec");
                }
            }
        }
        ...
        public bool BrakNumerowIdentyfikacyjnych
        {
            ...
            set
            {
                if (this.brakNumerowIdentyfikacyjnychField != value)
                {
                    this.brakNumerowIdentyfikacyjnychField = value;
                    this.OnPropertyChanged("BrakNumerowIdentyfikacyjnych");
                }
            }
        }
