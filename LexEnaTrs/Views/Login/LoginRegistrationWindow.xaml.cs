namespace LexEnaTrs.LoginUI
{
    ...
    public partial class LoginRegistrationWindow : ChildWindow
    {
        ...
        public LoginRegistrationWindow(bool mode)
        {
            InitializeComponent();
            ...
            this.LayoutUpdated += this.GoToInitialState2;
            this.LayoutUpdated += this.UpdateTitle;
        }
        /// <summary>
        ...
        private void GoToInitialState2(object sender, EventArgs eventArgs)
        {
            VisualStateManager.GoToState(this, "AtRegistration", false);
            this.LayoutUpdated -= this.GoToInitialState2;
