namespace LexEnaTrs
{
    ...
    public partial class ErrorWindow : ChildWindow
    {
        ...
        public static void CreateNew(Exception exception, string message)
        {
            if (exception == null)
            {
            ...
            CreateNew(message + "\n\r" + ConvertExceptionToMessage(exception), fullStackTrace, StackTracePolicy.OnlyWhenDebuggingOrRunningLocally);
        }
